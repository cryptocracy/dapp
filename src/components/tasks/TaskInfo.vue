    ...
    <v-list two-line>
      ...
      <v-list-tile v-if="taskObject.amount">
        <v-list-tile-content>
          ...
          <v-progress-circular size="64" width="8" class="task-progress" :value="+currentAmount/taskObject.amount" color="teal">{{+currentAmount}}/{{taskObject.amount}}</v-progress-circular>
        </v-list-tile-content>
      </v-list-tile>
