const storageService = {
  ...
  updateFavoriteObjectIndex: (name, title, type) => storageService.updateIndex('my_fav_' + type + 's.json', [name, title]),
  reduceFavoriteObjectIndex: (name, title, type) => storageService.updateIndex('my_fav_' + type + 's.json', [name, title], true),
